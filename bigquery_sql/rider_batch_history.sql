...
--  use unnest since the batches field is repeated, not nullable
...
--  use unnest since the rider.deliveries field is repeated, not nullable
...
-- order time between batch active interval
